...
import noti from '../component/noti.png'



export default function NavbarSH() {
  return (
    <div>
  ...
  <div class="container-fluid">
   <img src={pic} alt="" className='navpic'/>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <li class="nav-item">
          <a class="nav-link" href="#"><img src={noti} alt="" className='Usericon'/></a>
        </li>
      ...
      <li class="nav-item">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="/Sellerorders">orders</a></li>
