...
export default function Adsellerview() {
  ...
  const [state, setState] = useState([])
    ...
    useEffect(() => {
        axios.get('http://127.0.0.1:8000/api/sUserView').then((response) => {
              ...
              {state?.map((data) => (
                <div className='col lg-3'>
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">{data.splace}</p>
                  </div>
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item">{data.sphone}</li>
